...
export class Authentication {
  ...
  constructor(
    @Inject(BROWSER_STORAGE) private storage: Storage, private tripData: TripData) {}
  ...
  //Retrieve the current user. This function should only be called after the calling method has checked to make usre that the user isLoggedIn
  ...
  //Because the method returns an observable, we subscribe to the result and only process when the Observable condition is satisfied
  //Note: This method is nearly identical to the login method because the behavior of the API logs a new user in immediately upon registration
